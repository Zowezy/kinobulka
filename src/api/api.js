...
export default {
  ...
  // Популярное
    getPopularItems(type,year) {
      ...
      return api.get(`movie?page=1&limit=30&selectFields=id&selectFields=name&selectFields=year&selectFields=rating&selectFields=genres&selectFields=poster&sortField=votes.imdb&sortType=-1&type=${type}&year=${year}`)
    },
    getVideo(id) {
